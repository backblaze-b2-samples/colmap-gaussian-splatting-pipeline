...
Make COLMAP Gaussian Splatting Pipeline the canonical identity across the shipped web app,
...
The web app and local API now ship under the COLMAP Gaussian Splatting Pipeline identity.
